        ...
        <section class="content">
            <div class="row">
                <section class="content-header">
                    <h1><a href="{{route('district_add')}}" class="btn btn-primary">{{ __('Add New')}}</a></h1>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($districts as $key => $district)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('district_edit', base64_encode($district->id))}}"
                                               class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                            <a href="{{route('district_delete', base64_encode
                                     ($district->id))}}" id="delete" class="btn btn-sm btn-primary"><i class="fa fa-trash"></i></a></td>
