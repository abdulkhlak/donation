...
<div class="slider-wrap">
    <div id="slider_1" class="owl-carousel" data-nav="true" data-dots="false" data-autoplay="true" data-autoplaytimeout="17000">
        ...
        <div class="slider_item_container" data-bg_img="{{asset('frontend')}}/images/home_1_slider_1.jpg" data-bg_color="#555555" data-bg_opacity="0.0">
            <div class="item">
        ...
        <div class="slider_item_container" data-bg_img="{{asset('frontend')}}/images/home_1_slider_2.jpg" data-bg_color="#555555" data-bg_opacity="0.0" >
            <div class="item">
                <div class="slider-content">
                    <div class="container text-left">
                        <div class="row">
